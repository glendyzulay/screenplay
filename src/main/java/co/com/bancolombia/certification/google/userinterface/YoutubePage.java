...
public class YoutubePage {
	...
	public static final Target TOTAL_RESULTADOS = Target.the("Total Result").located(By.id("result-count"));
	//public static final Target LISTA_RESULTADOS = Target.the("List Total Result").located(By.xpath("//*[@id=\'contents\']"));
}
